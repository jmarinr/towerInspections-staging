...
const APP_VERSION_DISPLAY = '2.5.96'
      ...
      triggerAutosave: (formCode) => {
        ...
        try {
          if (formCode) {
            ...
            if (payload) {
              // Pass assigned_to if this form was explicitly claimed by current user
              ...
              queueSubmissionSync(formCode, payload, APP_VERSION_DISPLAY, assignedTo)
