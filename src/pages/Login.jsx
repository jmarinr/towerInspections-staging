...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('[Login] v2.6.6 — deviceId:', deviceId.slice(0, 8))
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4">
      ...
      <p className="text-xs text-gray-400 mt-6">PTI Inspect v2.6.6{import.meta.env.VITE_APP_ENV === 'sandbox' ? ' · Sandbox' : ''}</p>
